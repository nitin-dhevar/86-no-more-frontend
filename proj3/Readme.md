|Software Sustainability Evaluation + Notes   |Score   |Evidence |
| :-------- | :-------- | :-------- |
|Does your website and documentation provide a clear, high-level overview of your software? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Does your website and documentation clearly describe the type of user who should use your software? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Do you publish case studies to show how your software has been used by yourself and others? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Is the name of your project/software unique? | Y |  |
|Is your project/software name free from trademark violations? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Is your software available as a package that can be deployed without building it?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main |
|Is your software available for free? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main |
|Is your source code publicly available to download, either as a downloadable bundle or via access to a source code repository? | Y | The entire source code is publicly available on github. https://github.com/nitin-dhevar/86-no-more-frontend/blob/main |
|Is your software hosted in an established, third-party repository likeGitHub (https://github.com), BitBucket (https://bitbucket.org),LaunchPad (https://launchpad.net) orSourceForge (https://sourceforge.net)?  | Y | https://github.com/nitin-dhevar/spendwise/blob/main |
|Is your documentation clearly available on your website or within your software?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main |
|Does your documentation include a "quick start" guide, that provides a short overview of how to use your software with some basic examples of use? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|If you provide more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use your software? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Do you provide a comprehensive guide to all your software’s commands, functions and options?  |Y  | Detailed and clear snapshots are provided on software commands which are used in the project. https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
...
|Do you store your documentation under revision control with your source code?  | Y | The revision control information is found with the respective commits. |
|Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your web site or in your documentation?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/releases |
|Does your software describe how a user can get help with using your software?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Does your website and documentation describe what support, if any, you provide to users and developers?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Does your project have an e-mail address or forum that is solely for supporting users?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/blob/main/README.md |
|Are e-mails to your support e-mail address received by more than one person?  | Y |  |
|Does your project have a ticketing system to manage bug reports and feature requests?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/projects?query=is%3Aopen |
|Is your project's ticketing system publicly visible to your users, so they can view bug reports and feature requests?  |Y  | https://github.com/nitin-dhevar/86-no-more-frontend/projects?query=is%3Aopen |
|Is your software’s architecture and design modular?  | Y | Yes, it is modular. |
...
|Does your software allow communications using open communications protocols? e.g. HTTP, FTP, XMPP, SOAP over HTTP,  or domain-specific ones  | Y | Yes, it uses HTTP. |
...
|Is your source code stored in a repository under revision control? | Y | https://github.com/nitin-dhevar/86-no-more-frontend/tree/main/src |
|Is each source code release a snapshot of the repository?  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/projects?query=is%3Aopen |
|Are releases tagged in the repository?  | Y |  |
|Is there a branch of the repository that is always stable? (i.e. tests always pass, code always builds successfully)  | Y | https://github.com/nitin-dhevar/86-no-more-frontend/tree/main |
|Do you back-up your repository?  | Y |  |
|Do you provide publicly-available instructions for building your software from the source code?  | Y | Yes, the software developed is intended to be open-source.  |
